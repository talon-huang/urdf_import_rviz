...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('go2')
    ...
    declare_urdf_cmd = DeclareLaunchArgument(
        'urdf_file',
        default_value=os.path.join(bringup_dir, 'urdf', 'go2w_description.urdf'),
    ...
    start_joint_state_publisher_cmd = Node(
        ...
        parameters=[{
            ...
            'use_gui': True,
            'joint_limits': os.path.join(bringup_dir, 'config', 'joint_limits.yaml')
        }],
    arguments=[urdf_file])
